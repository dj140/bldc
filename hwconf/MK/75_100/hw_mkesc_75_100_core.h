...
#ifndef HW_MKESC_75_100_CORE_H_
#define HW_MKESC_75_100_CORE_H_


#define HW_NAME					"MKESC_75_100"

// HW properties
#define HW_HAS_3_SHUNTS
#define HW_HAS_PHASE_SHUNTS
// #define HW_HAS_PHASE_FILTERS
#define BOOT_OK_BUZZER

// #define BOOT_OK_GPIO			GPIOB
// #define BOOT_OK_PIN				7
...
#define NTC_TEMP(adc_ind)		hw75_100_get_temp()
...
// ICU Peripheral for BUZZER 
#define HW_USE_BUZZER_TIM4
#define HW_BUZZER_TIMER			TIM4
#define HW_BUZZER_TIM_CLK_EN()	RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM4, ENABLE)
#define HW_BUZZER_DEV			ICUD4
#define HW_BUZZER_CHANNEL	    ICU_CHANNEL_2
#define HW_BUZZER_GPIO_AF		GPIO_AF_TIM4
#define HW_BUZZER_GPIO			GPIOB
#define HW_BUZZER_PIN		    7

// Buzzer
// #define HW_USE_BUZZER_TIM9
// #define BUZZER_GPIO			    GPIOA
// #define BUZZER_PIN		        3
// #define BUZZER_GPIO_AF		    GPIO_AF_TIM9
// #define BUZZER_PWM				PWMD9
// #define BUZZER_FREQ_HZ			4000
// #define BUZZER_PWM_FREQ_HZ		1000000
// #define BUZZER_ON()				pwmEnableChannel(&BUZZER_PWM, 1, PWM_PERCENTAGE_TO_WIDTH(&BUZZER_PWM, 5000))
// #define BUZZER_OFF()			pwmEnableChannel(&BUZZER_PWM, 1, PWM_PERCENTAGE_TO_WIDTH(&BUZZER_PWM, 0))
